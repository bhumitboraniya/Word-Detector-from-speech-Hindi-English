...
//                notificationManager.notify(0,mbuilder.build());
    ...
    private void sendNotification() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, channelId)
                ...
                .setContentTitle("'HELLO' DETECTED")
...
//    if(resultView.getText().toString().contains("hello"))
//    {
//        Toast.makeText(getApplicationContext(), "HALOOOOOOOOO", Toast.LENGTH_SHORT).show();
//
//    }
    ...
    public void onResult(String hypothesis) {
        ...
        if(resultView.getText().toString().contains("हेलो"))
        {
            sendNotification();
            resultView.setText("");
        }
